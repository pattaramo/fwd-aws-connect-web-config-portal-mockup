...
var define;
var global = arguments[3];
var e,n=arguments[3];!function(n,i){"object"==typeof exports&&"undefined"!=typeof module?module.exports=i():"function"==typeof e&&e.amd?e(i):n.confirmDatePlugin=i()}(this,function(){"use strict";var e={confirmIcon:"<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='17' height='17' viewBox='0 0 17 17'> <g> </g> <path d='M15.418 1.774l-8.833 13.485-4.918-4.386 0.666-0.746 4.051 3.614 8.198-12.515 0.836 0.548z' fill='#000000' /> </svg>",confirmText:"OK ",showAlways:!1,theme:"light"};return function(n){var i,t=Object.assign({},e,n);return function(e){return e.config.noCalendar||e.isMobile?{}:Object.assign({onKeyDown:function(n,t,o,r){e.config.enableTime&&"Tab"===r.key&&r.target===e.amPM?(r.preventDefault(),i.focus()):"Enter"===r.key&&r.target===i&&e.close()},onReady:function(){(i=e._createElement("div","flatpickr-confirm "+(t.showAlways?"visible":"")+" "+t.theme+"Theme",t.confirmText)).tabIndex=-1,i.innerHTML+=t.confirmIcon,i.addEventListener("click",e.close),e.calendarContainer.appendChild(i)}},t.showAlways?{}:{onChange:function(n,t){var o=e.config.enableTime||"multiple"===e.config.mode;if(t&&!e.config.inline&&o)return i.classList.add("visible");i.classList.remove("visible")}})}}});
},{}],"JYNU":[function(require,module,exports) {
var define;
var global = arguments[3];
var e,n=arguments[3];!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof e&&e.amd?e(t):n.scrollPlugin=t()}(this,function(){"use strict";function e(e){return Math.max(-1,Math.min(1,e.wheelDelta||-e.deltaY))}var n=function(n){n.preventDefault();var t=new CustomEvent("increment",{bubbles:!0});t.delta=e(n),n.target.dispatchEvent(t)};return function(){return function(t){var r=function(n){return function(t){t.preventDefault();var r=e(t);n.changeMonth(r)}}(t);return{onReady:function(){t.timeContainer&&t.timeContainer.addEventListener("wheel",n),t.yearElements.forEach(function(e){return e.addEventListener("wheel",n)}),t.monthElements.forEach(function(e){return e.addEventListener("wheel",r)})},onDestroy:function(){t.timeContainer&&t.timeContainer.removeEventListener("wheel",n),t.yearElements.forEach(function(e){return e.removeEventListener("wheel",n)}),t.monthElements.forEach(function(e){return e.removeEventListener("wheel",r)})}}}}});
},{}],"epB2":[function(require,module,exports) {
"use strict";Object.assign||Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:function(e){if(null==e)throw new TypeError("Cannot convert first argument to object");for(var t=Object(e),r=1;r<arguments.length;r++){var n=arguments[r];if(null!=n){n=Object(n);for(var a=Object.keys(Object(n)),i=0,c=a.length;i<c;i++){var o=a[i],l=Object.getOwnPropertyDescriptor(n,o);void 0!==l&&l.enumerable&&(t[o]=n[o])}}}return t}}),basecoat.FlatPickr=require("flatpickr"),basecoat.FlatPickrConfirmDate=require("flatpickr/dist/plugins/confirmDate/confirmDate"),basecoat.ScrollPlugin=require("flatpickr/dist/plugins/scrollPlugin"),function(e){e.fn.datetimePicker=function(t){return t=t||{closeOnSelect:!1,altInput:!0,altFormat:"j M Y",minuteIncrement:15,onClose:function(t,r,n){e(n.element).blur()}},this.find("[data-datetime-picker]").addBack("[data-datetime-picker]").each(function(){1==!e(this).attr("data-no-calendar")?t.plugins=[new basecoat.FlatPickrConfirmDate({confirmIcon:"",confirmText:"Select",showAlways:!0}),new basecoat.ScrollPlugin]:t.plugins=[new basecoat.FlatPickrConfirmDate({confirmIcon:"",confirmText:"Select",showAlways:!0})],e(this).flatpickr(t)})},e(document).datetimePicker()}(jQuery);
},{"flatpickr":"9vfs","flatpickr/dist/plugins/confirmDate/confirmDate":"mfQb","flatpickr/dist/plugins/scrollPlugin":"JYNU"}]},{},["epB2"], null)
//# sourceMappingURL=/ntt.basecoat.datetime-picker.min.map